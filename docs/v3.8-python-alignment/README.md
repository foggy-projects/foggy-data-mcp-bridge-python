...
- P0-79 adds the runtime/compiler refusal boundary around models that carry
...
- P0-79+ records the aggregate-join sequence as completed through P0-108, with
  ...
  evidence to left/root ON keys and request slices.
...
- Python P0-82 through P0-85 aggregate Java fixture replay passed:
  ...
  with `10 passed`.
- Python P0-86 through P0-88 documentation update kept the aggregate Java
...
- Python P0-103 non-join-key dimension property/`$id` request-slice coverage
  passed:

...
2. Align compose dialect fallback and source alias behavior where Java snapshots
   ...
   join/union snapshot cases. Broader dialect SQL-shape coverage remains open.

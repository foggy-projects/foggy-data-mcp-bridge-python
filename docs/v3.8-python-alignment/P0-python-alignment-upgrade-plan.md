...
- P0-79+ now records the aggregate-join continuation sequence as completed
  through P0-108, with P0-87 v2 snapshot/replay active, the
  ...
  left/root ON keys and request slices.

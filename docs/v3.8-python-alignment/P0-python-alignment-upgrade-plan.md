...
- P0-79+ now records the aggregate-join continuation sequence as completed
  through P0-112, with P0-87 v2 snapshot/replay active, the
  ...
  P0-111 records the required Java `querymodel-aggregate-join-4` fixture export
  plan for full O615 explicit join graph parity before Python opens positive
  O615 graph lowering. P0-112 adds the Python-side contract-only v4 fixture,
  manifest gate, and contract test without marking the O615 cases as
  Java-exported.

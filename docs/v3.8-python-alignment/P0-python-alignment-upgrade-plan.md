...
- P0-79+ now records the aggregate-join continuation sequence as completed
  through P0-102, with P0-87 v2 snapshot/replay active, the
  ...
  the full O615 explicit join graph fixture-led.

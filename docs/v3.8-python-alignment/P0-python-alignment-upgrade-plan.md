...
- P0-79+ now records the aggregate-join continuation sequence as completed
  through P0-109, with P0-87 v2 snapshot/replay active, the
  ...
  fail-closed evidence to RHS runtime `$id` filters.

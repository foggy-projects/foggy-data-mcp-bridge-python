...
3. Refresh timeWindow relative-date and pivot/domain-transport edge behavior.
   ...
   for those 9 Java-success happy cases; pivot and domain-transport edge
   behavior remain separate follow-ups.

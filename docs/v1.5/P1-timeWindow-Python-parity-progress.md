...
- G3/P3 follow-up 已完成 Java 8.5.0 契约对齐：`docs/v1.5/P1-timeWindow-calculatedFields-design-progress.md`。Python 已支持 timeWindow 结果列之上的后置 scalar calculatedFields；`targetMetrics` 引用 calc field、后置 agg/window/缺失列仍按 Java 同名错误码 fail-closed。

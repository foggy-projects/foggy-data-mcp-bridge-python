...
3. Stage 5: Phase 4 AST optional only if AST default flip becomes a concrete goal.
4. Stage 6: Future Java contract expansions only after Java publishes contract + fixtures.
